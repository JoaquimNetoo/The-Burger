...
from models import Produto, Pedido, ItemPedido, StatusPedido as StatusPedidoModel
from schemas import ProdutoOut, PedidoOut, PedidoCreate, StatusUpdate, PedidoOut
...
def criar_pedido(pedido: PedidoCreate, db: Session = Depends(get_db)):
    ...
    novo_pedido = Pedido(status=StatusPedidoModel.aguardando, total=total)
    db.add(novo_pedido)
